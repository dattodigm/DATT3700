...
![Computer Vision](https://img.shields.io/badge/Computer%20Vision-OpenCV%20%2B%20Face%20Tracking-2563eb?style=flat-square)
![Emotion AI](https://img.shields.io/badge/Emotion%20AI-DeepFace%20%2B%20ViT-7c3aed?style=flat-square)
![Robotics](https://img.shields.io/badge/Robotics-Servo%20%2B%20DC%20Motors-d97706?style=flat-square)
![OSC](https://img.shields.io/badge/OSC-WiFi%20Control-0f766e?style=flat-square)
![UI/UX](https://img.shields.io/badge/UI%2FUX-Hardware%20Dashboard-db2777?style=flat-square)
...
### Early Interaction Concept

下图是项目早期的交互概念草图，用来表达“人-感知层-机器代理-物理反馈”的循环关系。最终实现从这个概念收敛为摄像头人脸追踪、表情识别、Python Host 和 ESP32 花朵节点网络。
...
flowchart TB
    ...
    subgraph Physical_Actuators ["Physical Actuator Nodes"]
        ...
        Node_Kait["Kait Node:<br>1× ESP32 | 1× DC Motor <br>(Rotation)"]
    end
    Cam_USB --> VLM
